...
@section('contenido')
    ...
    <table class="table table-striped table-hover">
          <tr>
                      ...
                      <td><a href="reporteNovedad/1" target="_blank" ><button class="btn btn-block btn-primary btn-xs">Ver</button></a></td>
                      <td><a href="reporteNovedad/2" target="_blank" ><button class="btn btn-block btn-success btn-xs">Descargar</button></a></td>
                    </tr>
                    		</table>
		<table class="table table-striped table-hover">
