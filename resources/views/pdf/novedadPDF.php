...
<head>
	...
	<meta charset="UTF-8">
	<title>Reporte de novedad</title>
...
<div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title3" align="center">Reporte de Novedad - <?=  $date; ?></h3>
                  <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
...
<td>Media Hectarea	
                ...
                <div class="container">
                  ...
                  <?php foreach($data as $novedad){ ?>
                 
                    <tr>
                     
                    <td  style="width: 10px"  ><?= $novedad->id?></td>
